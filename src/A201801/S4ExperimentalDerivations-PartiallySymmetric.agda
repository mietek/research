module A201801.S4ExperimentalDerivations-PartiallySymmetric where
...
import A201801.S4StandardDerivationsLemmas as S4
...
id↓↑ (S4.app 𝒟 ℰ)    = S4.app & ( S4.id-cons-wk-sub S4.ids (↓ (↑ ℰ)) (↓ (↑ 𝒟))
                                ⋮ S4.id-sub (↓ (↑ 𝒟))
                                ⋮ id↓↑ 𝒟
                                )
                              ⊗ id↓↑ ℰ
