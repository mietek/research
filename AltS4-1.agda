...
infix 3 _⨾_
data _⨾_ : List Validity → Derivation → Set
  where
    var : ∀ {A Δ Γ} → Γ ∋ A true
                    → Δ ⨾ Γ ⊢ A true
...
-- pac : List Truth → List Truth → List Derivation
-- pac Γ ∙            = ∙
...
infix 3 _⨾⋆_
_⨾⋆_ : List Validity → Derivations → Set
Δ ⨾⋆ Γ ⊢⋆ Ξ = All (Δ ⨾_) (map (Γ ⊢_) Ξ)
