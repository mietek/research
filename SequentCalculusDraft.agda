...
thm311 : ∀ {A C Γ} → Γ ⟹ A → Γ , A ⟹ C
                   → Γ ⟹ C
thm311 {A}       (var i)      ℰ                  = renₛ (genct⊒ i) ℰ

thm311 {A}       𝒟            (var {B}  i)       with A ≟ₚ B
thm311 {A}       𝒟            (var {.A} i)       | yes refl = 𝒟
thm311 {A}       𝒟            (var {.A} zero)    | no A≢A   = refl ↯ A≢A
thm311 {A}       𝒟            (var {B}  (suc i)) | no A≢B   = var i

thm311 {A₁ ⊃ A₂} (⊃r 𝒟)       ℰ = {!!}

thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (⊃r ℰ)       = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (⊃l i ℰ₁ ℰ₂) = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (∧r ℰ₁ ℰ₂)   = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (∧l₁ i ℰ)    = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (∧l₂ i ℰ)    = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   ⊤r          = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (⊥l i)      = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (∨r₁ ℰ)      = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (∨r₂ ℰ)      = {!!}
thm311 {A₁ ∧ A₂} (∧r 𝒟₁ 𝒟₂)   (∨l i ℰ₁ ℰ₂) = {!!}
...
thm311 {A}       (⊃l i 𝒟₁ 𝒟₂) ℰ = ⊃l i 𝒟₁ (thm311 𝒟₂ (exₛ (wkₛ ℰ)))
thm311 {A}       (∧l₁ i 𝒟)    ℰ = ∧l₁ i (thm311 𝒟 (exₛ (wkₛ ℰ)))
thm311 {A}       (∧l₂ i 𝒟)    ℰ = ∧l₂ i (thm311 𝒟 (exₛ (wkₛ ℰ)))
thm311 {A}       (⊥l i)      ℰ = ⊥l i
thm311 {A}       (∨l i 𝒟₁ 𝒟₂) ℰ = ∨l i (thm311 𝒟₁ (exₛ (wkₛ ℰ))) (thm311 𝒟₂ (exₛ (wkₛ ℰ)))
