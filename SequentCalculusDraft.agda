...
thm311 {A₁ ⊃ A₂} (⊃R 𝒟)     (⊃L zero ℰ₁ ℰ₂)    = thm311 (⊃R 𝒟) (thm311 (⊃L zero ℰ₁ vzₛ) ℰ₂)
thm311 {A₁ ∧ A₂} (∧R 𝒟₁ 𝒟₂) (∧L₁ zero ℰ)       = thm311 (∧R 𝒟₁ 𝒟₂) (thm311 (wkₛ 𝒟₁) ℰ)
thm311 {A₁ ∧ A₂} (∧R 𝒟₁ 𝒟₂) (∧L₂ zero ℰ)       = thm311 (∧R 𝒟₁ 𝒟₂) (thm311 (wkₛ 𝒟₂) ℰ)
thm311 {A₁ ∨ A₂} (∨R₁ 𝒟)    (∨L zero ℰ₁ ℰ₂)    = thm311 (∨R₁ 𝒟) (thm311 (wkₛ 𝒟) ℰ₁)
thm311 {A₁ ∨ A₂} (∨R₂ 𝒟)    (∨L zero ℰ₁ ℰ₂)    = thm311 (∨R₂ 𝒟) (thm311 (wkₛ 𝒟) ℰ₂)

thm311 {A₁ ⊃ A₂} (⊃R 𝒟)     (⊃L (suc i) ℰ₁ ℰ₂) = ⊃L i (thm311 (⊃R 𝒟) ℰ₁) (thm311 (⊃R (exₛ (wkₛ 𝒟))) (exₛ ℰ₂))
thm311 {A₁ ∧ A₂} (∧R 𝒟₁ 𝒟₂) (⊃L (suc i) ℰ₁ ℰ₂) = ⊃L i (thm311 (∧R 𝒟₁ 𝒟₂) ℰ₁) (thm311 (wkₛ (∧R 𝒟₁ 𝒟₂)) (exₛ ℰ₂))
thm311 {⊤}      ⊤R        (⊃L (suc i) ℰ₁ ℰ₂) = ⊃L i (thm311 ⊤R ℰ₁) (thm311 ⊤R (exₛ ℰ₂))
thm311 {A₁ ∨ A₂} (∨R₁ 𝒟)    (⊃L (suc i) ℰ₁ ℰ₂) = ⊃L i (thm311 (∨R₁ 𝒟) ℰ₁) (thm311 (wkₛ (∨R₁ 𝒟)) (exₛ ℰ₂))
thm311 {A₁ ∨ A₂} (∨R₂ 𝒟)    (⊃L (suc i) ℰ₁ ℰ₂) = ⊃L i (thm311 (∨R₂ 𝒟) ℰ₁) (thm311 (wkₛ (∨R₂ 𝒟)) (exₛ ℰ₂))

thm311 {A₁ ⊃ A₂} (⊃R 𝒟)     (∧L₁ (suc i) ℰ)    = ∧L₁ i (thm311 (⊃R (exₛ (wkₛ 𝒟))) (exₛ ℰ))
thm311 {A₁ ∧ A₂} (∧R 𝒟₁ 𝒟₂) (∧L₁ (suc i) ℰ)    = ∧L₁ i (thm311 (wkₛ (∧R 𝒟₁ 𝒟₂)) (exₛ ℰ))
thm311 {⊤}      ⊤R        (∧L₁ (suc i) ℰ)    = ∧L₁ i (thm311 ⊤R (exₛ ℰ))
thm311 {A₁ ∨ A₂} (∨R₁ 𝒟)    (∧L₁ (suc i) ℰ)    = ∧L₁ i (thm311 (wkₛ (∨R₁ 𝒟)) (exₛ ℰ))
thm311 {A₁ ∨ A₂} (∨R₂ 𝒟)    (∧L₁ (suc i) ℰ)    = ∧L₁ i (thm311 (wkₛ (∨R₂ 𝒟)) (exₛ ℰ))
...
thm311 {A₁ ⊃ A₂} (⊃R 𝒟)     (∨L (suc i) ℰ₁ ℰ₂) = ∨L i (thm311 (wkₛ (⊃R 𝒟)) (exₛ ℰ₁)) (thm311 (wkₛ (⊃R 𝒟)) (exₛ ℰ₂))
thm311 {A₁ ∧ A₂} (∧R 𝒟₁ 𝒟₂) (∨L (suc i) ℰ₁ ℰ₂) = ∨L i (thm311 (wkₛ (∧R 𝒟₁ 𝒟₂)) (exₛ ℰ₁)) ((thm311 (wkₛ (∧R 𝒟₁ 𝒟₂)) (exₛ ℰ₂)))
thm311 {⊤}      ⊤R        (∨L (suc i) ℰ₁ ℰ₂) = ∨L i (thm311 ⊤R (exₛ ℰ₁)) (thm311 ⊤R (exₛ ℰ₂))
thm311 {A₁ ∨ A₂} (∨R₁ 𝒟)    (∨L (suc i) ℰ₁ ℰ₂) = ∨L i (thm311 (wkₛ (∨R₁ 𝒟)) (exₛ ℰ₁)) (thm311 (wkₛ (∨R₁ 𝒟)) (exₛ ℰ₂))
thm311 {A₁ ∨ A₂} (∨R₂ 𝒟)    (∨L (suc i) ℰ₁ ℰ₂) = ∨L i (thm311 (wkₛ (∨R₂ 𝒟)) (exₛ ℰ₁)) (thm311 (wkₛ (∨R₂ 𝒟)) (exₛ ℰ₂))
