...
import BasicIS4.Hilbert.TreeWithContextPair.TarskiSoundness as TCP
open import BasicIS4.Translation
...
--   eval {A} t γ δ = hn⇒g {A} (TCP.Closed.eval (g→hn t) (g⇒hn⋆ γ) (g⇒hn⋆ δ))
--
...
--
--   eval : ∀ {A Γ Δ} → Γ ⁏ Δ ⊢ A → Γ ⁏ Δ ᴹ⊨ A
--   eval {A} t γ δ = hn⇒g {A} (TCP.Open.eval (g→hn t) (g⇒hn⋆ γ) (g⇒hn⋆ δ))
--
--   -- FIXME: How to write this without translation?
--   postulate
