...
quot (_∙ⁿ_ {n} D₀ D₁)    = quot D₀ ∘[ suc n ] quot D₁
quot (𝒑ⁿ⟨_,_⟩ {n} D₀ D₁) = 𝑝[ suc n ]⟨ quot D₀ , quot D₁ ⟩
...
int⊢ (_∙ⁿ_ {𝐭 = 𝐭} {𝐬} D₀ D₁) =
    _∙ⁿ_ {𝐭 = quot D₀ ∷ 𝐭} {𝐬 = quot D₁ ∷ 𝐬} (int⊢ D₀) (int⊢ D₁)

int⊢ (𝒑ⁿ⟨_,_⟩ {𝐭 = 𝐭} {𝐬} D₀ D₁) =
    𝒑ⁿ⟨_,_⟩ {𝐭 = quot D₀ ∷ 𝐭} {𝐬 = quot D₁ ∷ 𝐬} (int⊢ D₀) (int⊢ D₁)
...
wk⊢ Γ (_∙ⁿ_ {𝐭 = 𝐭} {𝐬} D₀ D₁) =
    _∙ⁿ_ {𝐭 = 𝐭} {𝐬} (wk⊢ Γ D₀) (wk⊢ Γ D₁)

wk⊢ Γ (𝒑ⁿ⟨_,_⟩ {𝐭 = 𝐭} {𝐬} D₀ D₁) =
    𝒑ⁿ⟨_,_⟩ {𝐭 = 𝐭} {𝐬} (wk⊢ Γ D₀) (wk⊢ Γ D₁)
