...
wk⊢ Γ⊆F (R𝜈ⁿ {𝐱 = 𝐱} {𝐚 = 𝐚} i)
    = R𝜈ⁿ {𝐱 = 𝐱} {𝐚 = 𝐚} (wk∈ Γ⊆F i)

wk⊢ Γ⊆F (R𝜆ⁿ {𝐱 = 𝐱} {𝐭 = 𝐭} D)
    = R𝜆ⁿ {𝐱 = 𝐱} {𝐭 = 𝐭} (wk⊢ (keep Γ⊆F) D)

wk⊢ Γ⊆F (R∘ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} Dₜ Dₛ)
    = R∘ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} (wk⊢ Γ⊆F Dₜ) (wk⊢ Γ⊆F Dₛ)

wk⊢ Γ⊆F (R𝑝ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} Dₜ Dₛ)
    = R𝑝ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} (wk⊢ Γ⊆F Dₜ) (wk⊢ Γ⊆F Dₛ)
...
ex⊢ Γ%F (R𝜈ⁿ {𝐱 = 𝐱} {𝐚 = 𝐚} i)
    = R𝜈ⁿ {𝐱 = 𝐱} {𝐚 = 𝐚} (ex∈ Γ%F i)

ex⊢ Γ%F (R𝜆ⁿ {𝐱 = 𝐱} {𝐭 = 𝐭} D)
    = R𝜆ⁿ {𝐱 = 𝐱} {𝐭 = 𝐭} (ex⊢ (weak Γ%F) D)

ex⊢ Γ%F (R∘ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} Dₜ Dₛ)
    = R∘ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} (ex⊢ Γ%F Dₜ) (ex⊢ Γ%F Dₛ)

ex⊢ Γ%F (R𝑝ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} Dₜ Dₛ)
    = R𝑝ⁿ {𝐭 = 𝐭} {𝐬 = 𝐬} (ex⊢ Γ%F Dₜ) (ex⊢ Γ%F Dₛ)
