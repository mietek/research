...
quot : ∀{B Γ} → Γ ⊢ B → Tm
quot (𝒗_ {x = x} i)    = 𝑣 x
quot (𝝀ⁿ_ {n} D)       = 𝜆[ suc n ] quot D
quot (_∙ⁿ_ {n} D C)    = quot D ∘[ suc n ] quot C
quot (𝒑ⁿ⟨_,_⟩ {n} D C) = 𝑝[ suc n ]⟨ quot D , quot C ⟩
quot (𝝅₀ⁿ_ {n} D)      = 𝜋₀[ suc n ] quot D
quot (𝝅₁ⁿ_ {n} D)      = 𝜋₁[ suc n ] quot D
quot (⬆ⁿ_ {n} D)       = ⇑[ suc n ] quot D
quot (⬇ⁿ_ {n} D)       = ⇓[ suc n ] quot D
...
int⊢ (𝝀ⁿ_ {𝐭 = 𝐭} D) =
    𝝀ⁿ_ {𝐭 = quot D ∷ 𝐭} (int⊢ D)

int⊢ (_∙ⁿ_ {𝐭 = 𝐭} {𝐬} D C) =
    _∙ⁿ_ {𝐭 = quot D ∷ 𝐭} {𝐬 = quot C ∷ 𝐬} (int⊢ D) (int⊢ C)

int⊢ (𝒑ⁿ⟨_,_⟩ {𝐭 = 𝐭} {𝐬} D C) =
    𝒑ⁿ⟨_,_⟩ {𝐭 = quot D ∷ 𝐭} {𝐬 = quot C ∷ 𝐬} (int⊢ D) (int⊢ C)

int⊢ (𝝅₀ⁿ_ {𝐭 = 𝐭} D) =
    𝝅₀ⁿ_ {𝐭 = quot D ∷ 𝐭} (int⊢ D)
...
wk⊢ Γ (_∙ⁿ_ {𝐭 = 𝐭} {𝐬} D C) =
    _∙ⁿ_ {𝐭 = 𝐭} {𝐬} (wk⊢ Γ D) (wk⊢ Γ C)

wk⊢ Γ (𝒑ⁿ⟨_,_⟩ {𝐭 = 𝐭} {𝐬} D C) =
    𝒑ⁿ⟨_,_⟩ {𝐭 = 𝐭} {𝐬} (wk⊢ Γ D) (wk⊢ Γ C)
