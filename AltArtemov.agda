...
infixr 8 𝑣_ 𝑣²_ 𝑣^[_]_ !_ ⇓_ ⇑_ ⇓²_ ⇑²_ ⇓^[_]_ ⇑^[_]_ 
...
_,ⁿ_∶_ {zero}  Γ ∅        ∅        = Γ
_,ⁿ_∶_ {suc n} Γ (xₙ ∷ 𝒙) (Aₙ ∷ 𝑨) = (Γ ,ⁿ 𝒙 ∶ 𝑨) , (𝑣^[ suc n ] xₙ ∶ Aₙ)
...
postulate
  lem1 : {n m : ℕ} {x : Var} {𝒙 : VVar m} {A B : Ty} {Γ : Cx}    -- XXX: How to prove this?
    → Γ ,              𝑣ⁿ 𝒙 ∶ A ⊢ B
    → Γ , (𝑣^[ n ] x ∶ 𝑣ⁿ 𝒙 ∶ A) ⊢ B
